...
function singJaViElser() {
    return "JAAAA vi elsker dette landet, som det stiger frem ..................";
}

function shoutG(callback) {
    return callback().toUpperCase();
}

console.log(shoutG(singJaViElser));

// console.log(shoutG(greetA)); ==> "WELCOME!"
